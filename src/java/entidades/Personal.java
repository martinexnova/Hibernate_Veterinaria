...
public class Personal  implements java.io.Serializable {
    ...
    public Personal(int idPersonal, String nombre, String dni, String telefono, String cargo, String email, String apellidos) {
    ...
    public Personal(int idPersonal, String nombre, String dni, String telefono, String cargo, String email, String apellidos, Set usuarios, Set atencions) {
       this.idPersonal = idPersonal;
       this.nombre = nombre;
       this.dni = dni;
       this.telefono = telefono;
